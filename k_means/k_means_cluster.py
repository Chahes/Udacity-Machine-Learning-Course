...
for key in data_dict:
    if data_dict[key]['exercised_stock_options'] > max_stock and data_dict[key]['exercised_stock_options']!='NaN':
        max_stock = data_dict[key]['exercised_stock_options']
    if data_dict[key]['exercised_stock_options'] < min_stock and data_dict[key]['exercised_stock_options']!='NaN':
        min_stock = data_dict[key]['exercised_stock_options']
print max_stock,min_stock
max_sal = -1.0
min_sal = float("inf")
for key in data_dict:
    if data_dict[key]['salary'] > max_sal and data_dict[key]['salary']!='NaN':
        max_sal = data_dict[key]['salary']
    if data_dict[key]['salary'] < min_sal and data_dict[key]['salary']!='NaN':
        min_sal = data_dict[key]['salary']
...
salary = [min_sal,200000.0,max_sal]
ex_stok = [min_stock,1000000.0,max_stock]
